...
firstTrain = true;
RPnoRuns = 2; % number of random runs
...
if ~fImpNR           %% implicit errors 
    QSSAc1c2_MSE = [mse(QSSAc1c2_SIM(1,:),zeros(size(z2All(1,:)))); mse(QSSAc1c2_SIM(2,:),zeros(size(z2All(2,:))))];       %% h_QSSAc1c2(z1,z2,z3,z4)-0
    PEA13c1c2_MSE = [mse(PEA13c1c2_SIM(1,:),zeros(size(z2All(1,:)))); mse(PEA13c1c2_SIM(2,:),zeros(size(z2All(2,:))))];    %% h_PEA13c1c2(z1,z2,z3,z4)-0
    CSP11c1c2_MSE = [mse(CSP11c1c2_SIM(1,:),zeros(size(z2All(1,:)))); mse(CSP11c1c2_SIM(2,:),zeros(size(z2All(2,:))))];    %% h_CSP11c1c2(z1,z2,z3,z4)-0
    CSP21c1c2_MSE = [mse(CSP21c1c2_SIM(1,:),zeros(size(z2All(1,:)))); mse(CSP21c1c2_SIM(2,:),zeros(size(z2All(2,:))))];    %% h_CSP21c1c2(z1,z2,z3,z4)-0
    QSSAc1c2_Linf = [norm(QSSAc1c2_SIM(1,:),Inf); norm(QSSAc1c2_SIM(2,:),Inf)]; 
    PEA13c1c2_Linf = [norm(PEA13c1c2_SIM(1,:),Inf); norm(PEA13c1c2_SIM(2,:),Inf)];    
    CSP11c1c2_Linf = [norm(CSP11c1c2_SIM(1,:),Inf); norm(CSP11c1c2_SIM(2,:),Inf)];    
    CSP21c1c2_Linf = [norm(CSP21c1c2_SIM(1,:),Inf); norm(CSP21c1c2_SIM(2,:),Inf)];    
    QSSAc1c2_L2 = [norm(QSSAc1c2_SIM(1,:),2); norm(QSSAc1c2_SIM(2,:),2)]; 
    PEA13c1c2_L2 = [norm(PEA13c1c2_SIM(1,:),2); norm(PEA13c1c2_SIM(2,:),2)];    
    CSP11c1c2_L2 = [norm(CSP11c1c2_SIM(1,:),2); norm(CSP11c1c2_SIM(2,:),2)];    
    CSP21c1c2_L2 = [norm(CSP21c1c2_SIM(1,:),2); norm(CSP21c1c2_SIM(2,:),2)]; 
else                %% explicit with NR
    QSSAc1c2_MSE = [mse(QSSAc1c2_SIM(1,:),z2All(1,:)); mse(QSSAc1c2_SIM(2,:),z2All(2,:))];       
